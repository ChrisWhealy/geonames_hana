...
module.exports = {
  ...
  , parameters   : {
    ...
    , continentCode          : { operators : settings.simpleEquality,      colName : 'CONTINENT_CONTENTCODE'}
    , continentContinentCode : { operators : settings.simpleEquality,      colName : 'CONTINENT_CONTENTCODE'}
    }
  , colNames : []
}
